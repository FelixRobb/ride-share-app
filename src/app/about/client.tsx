      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="space-y-8">
          <section>
            ...
            <p>
              Our goal is to reduce traffic congestion, lower carbon emissions, and foster a sense
              of community among travelers. By leveraging technology and social connections,
              we&apos;re building a safer, more sustainable alternative to traditional ride-sharing
              services.
            </p>
          </section>
          <section>
            ...
            <p className="mb-4">
              ...
              contacts. Whether you&apos;re commuting to work, heading to an event, or planning a
              road trip, RideShare makes it simple to find travel companions and share the journey.
            </p>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>
                <strong>Sustainability:</strong> By promoting ride-sharing, we contribute to
                reducing carbon emissions and minimizing our environmental impact.
              </li>
              <li>
                <strong>Innovation:</strong> We continuously improve our platform, incorporating
                user feedback and leveraging the latest technologies to enhance user experience and
                efficiency.
              </li>
              <li>
          ...
          <section>
            ...
            <p className="mb-4">
              ...
              community and sustainable transportation. Our diverse team brings together expertise
              in technology, urban planning, and community building.
            </p>
            <p>
          ...
          <section>
            ...
            <p className="mb-4">
              RideShare is built using cutting-edge web technologies, ensuring a smooth and
              responsive experience across all devices. We employ industry-standard security
              measures to protect your data and maintain the integrity of our platform.
            </p>
            <p>
          ...
          <section>
            ...
            <p className="mb-6">
              Sign up today and start sharing rides with people you trust. Together, we can make
              every journey more enjoyable, affordable, and environmentally friendly.
            </p>
            <div className="flex space-x-4">
              ...
              <Button asChild variant="outline">
                <a href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL}`}>Contact Us</a>
              </Button>
            </div>
          </section>
        </div>
