                      ...
                      <TableBody>
                        {reports.map((report) => (
                          <TableRow key={report.id}>
                            <TableCell>
                              <Badge
                                variant={report.report_type === "user" ? "default" : "secondary"}
                              >
                      ...
                      <CardContent>
                        <p className="text-3xl font-bold">
                          {stats.totalReports > 0
                            ? `${Math.round(
                                ((stats.totalReports - stats.pendingReports) / stats.totalReports) *
                                  100
                              )}%`
                            : "0%"}
                        </p>
              ...
              <div className="space-y-4 pr-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Badge
                      variant={selectedReport.report_type === "user" ? "default" : "secondary"}
                      className="mb-4"
                    >
          ...
          <DialogFooter className="gap-2 sm:gap-0">
            ...
            <Button
              onClick={() => {
                ...
                setTimeout(() => handleOpenUpdateDialog(reportToUpdate as Report), 100);
              }}
            >
              Update Status
            </Button>
      ...
      <Dialog open={updateDialogOpen} onOpenChange={handleUpdateDialogClose}>
        <DialogContent className="sm:max-w-[600px] max-h-[90vh] rounded-lg overflow-auto w-11/12">
          <DialogHeader>
            ...
            <DialogDescription>
              Change the status of this report and add admin notes
            </DialogDescription>
          </DialogHeader>
