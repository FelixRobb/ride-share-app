            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Minimum 10 characters. Please be specific about what you were doing when the bug
                  occurred.
                </p>
              </div>
              ...
              <div className="bg-muted/40 p-4 rounded-lg space-y-4">
                <h4 className="text-sm font-medium text-muted-foreground">
                  System Information (Automatically Detected)
                </h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="device_info" className="text-xs text-muted-foreground">
                      Device Info
                    </Label>
                    <Input
                      id="device_info"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="browser_info" className="text-xs text-muted-foreground">
                      Browser Info
                    </Label>
                    <Input
                      id="browser_info"
            ...
            <CardFooter className="flex flex-col sm:flex-row sm:justify-between gap-4 pt-2 pb-6 px-6">
              ...
              <Button
                ...
                className={`w-full sm:w-auto order-1 sm:order-2 ${
                  formData.severity
                    ? `bg-${formData.severity === "critical" ? "red" : formData.severity === "high" ? "orange" : formData.severity === "medium" ? "amber" : "green"}-600 hover:bg-${formData.severity === "critical" ? "red" : formData.severity === "high" ? "orange" : formData.severity === "medium" ? "amber" : "green"}-700`
                    : ""
                }`}
              >
                {isSubmitting ? (
