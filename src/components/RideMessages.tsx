...
export function RideMessages({ ride, currentUser, contacts, isOnline, isRefreshing }: RideMessagesProps) {
                                    ...
                                    >
                                        ...
                                        <div className="flex items-end gap-2 max-w-[70%]">
                                            ...
                                            <div className="relative max-w-full message-container">
                                                <div className={`px-4 py-2 shadow-sm overflow-hidden ${isCurrentUser ? "bg-primary text-primary-foreground rounded-lg rounded-br-none"
