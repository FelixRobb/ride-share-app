...
export function ReportDialog({
  ...
  const handleOpenChange = (open: boolean) => {
    if (!open) {
      // Delay resetting the form state to prevent flashing
      setTimeout(() => {
        setReason("");
        setDetails("");
        setIsSuccess(false);
        ...
        {!isSuccess ? (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Report {reportType === "user" ? reportedName : "this ride"} for violating community
                guidelines.
              </DialogDescription>
            </DialogHeader>
            <ScrollArea className="max-h-[60vh]">
              ...
              >
                ...
                <AlertDescription>
                  False reports may result in action against your account. Please only submit
                  genuine concerns.
                </AlertDescription>
              </Alert>

              <div className="space-y-2 w-11/12 mx-auto mb-3">
            ...
            <DialogFooter>
              ...
              <Button type="submit" className="mb-2" disabled={isSubmitting} onClick={handleSubmit}>
                {isSubmitting ? (
