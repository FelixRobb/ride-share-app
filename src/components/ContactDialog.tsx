...
export function ContactDialog({ currentUser, contacts, fetchUserData }: ContactDialogProps) {
  ...
  const handleAddContact = useCallback(
    ...
    [currentUser.id, isOnline, fetchUserData, fetchSuggestedContacts],
  )
  ...
  const handleAcceptContact = useCallback(
    ...
    [currentUser.id, isOnline, fetchUserData],
  )
  ...
  const ContactDialogContent = useMemo(
    () => (
      <div className="px-4 py-6 w-full max-w-[100vw]">
        ...
        <Tabs defaultValue="all" className="w-full">
          ...
          <TabsContent value="all" className="mt-0">
            <ScrollArea className="h-[calc(90svh-300px)]">
    ...
    [contacts, suggestedContacts, isFetchingSuggestions, searchQuery, searchResults, isSearching, addingUserId, deletingContactId, handleAddContact, handleAcceptContact, handleDeleteContact, handleOpenContactDetails, getContactStatus, isOnline, currentUser],
  )
    ...
    <div>
      {isMobile ? (
        <Drawer open={isOpen} onOpenChange={setIsOpen}>
          ...
          <DrawerContent className="h-[90svh]">
            <DrawerHeader className="pb-4">
              ...
              <DrawerDescription>Manage your contacts</DrawerDescription>
            </DrawerHeader>
            <ScrollArea className="flex-1">{ContactDialogContent}</ScrollArea>
          </DrawerContent>
        </Drawer>
      ) : (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
          ...
          <DialogContent className="sm:max-w-[800px] w-[95vw] p-0 h-[90vh] flex flex-col overflow-hidden rounded-md">
            <DialogHeader className="px-6 py-4 border-b shrink-0">
              <DialogTitle className="text-xl font-semibold flex items-center justify-between">Contacts</DialogTitle>
            </DialogHeader>
            <ScrollArea className="flex-1">{ContactDialogContent}</ScrollArea>
          </DialogContent>
        </Dialog>
