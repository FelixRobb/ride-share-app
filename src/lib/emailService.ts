...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>We're thrilled to have you join our community of ride-sharers. Get ready for a smoother, more connected
                way to
                travel!</p>

            <div class="info-section">
                <div class="card-header">What RideShare Offers</div>
                <div class="list-item">
                    <div class="list-icon">1</div>
                    <div>
                        <strong>Discover Rides</strong>
                ...
                <div class="list-item">
                    ...
                    <div>
                        ...
                        <p>Reduce your carbon footprint with every shared trip</p>
                    </div>
                </div>
            </div>

            <div class="button-container">
                <a href="${process.env.NEXT_PUBLIC_APP_URL}/dashboard" class="button">Start Sharing Rides</a>
            </div>

            <p class="text-center">This link will connect you to your personal dashboard.</p>
        </div>
        <div class="footer">
            <p>Questions? Contact our support team at <a
                    href="mailto:${process.env.GMAIL_USER}">${process.env.GMAIL_USER}</a>
            </p>
  ...
  <div class="email-container">
    ...
    <div class="content">
      ...
      <div class="warning-section">
        <strong class="text-destructive">⚠️ Important:</strong> If you didn't create an account with RideShare, please
        ignore this email or contact our support team at <a
          href="mailto:${process.env.GMAIL_USER}">${process.env.GMAIL_USER}</a>
      </div>
    </div>
    <div class="footer">
...
<body>
  <div class="email-container">
    ...
    <div class="content">
      ...
      <p>We received a request to reset the password for your RideShare account. If you didn't make this request, you
      ...
      <p class="text-center">This link will expire in 1 hour for security reasons.</p>

      <div class="warning-section">
        <strong class="text-destructive">⚠️ Important:</strong> If you didn't request a password reset, please contact
        our support team immediately at <a href="mailto:${process.env.GMAIL_USER}">${process.env.GMAIL_USER}</a>
      </div>

      <div class="info-section">
        <div class="card-header">Keeping Your Account Secure</div>
        <div class="list-item">
          <div class="list-icon">1</div>
...
<body>
  <div class="email-container">
    ...
    <div class="content">
      ...
      <div class="card">
        <div class="card-header">Your Email Has Been Changed</div>
        <p>Your RideShare account email has been changed to:</p>
        <p><strong>${newEmail}</strong></p>
      </div>

      <div class="warning-section">
        <div class="card-header text-destructive">⚠️ Security Alert</div>
      ...
      <div class="info-section">
        <div class="card-header">Recommended Security Steps</div>
        <p>• Enable two-factor authentication if you haven't already</p>
        <p>• Update your security questions</p>
        <p>• Review recent account activity</p>
        <p>• Update passwords on other services if you use the same password</p>
      </div>

      <div class="button-container">
        <a href="${process.env.NEXT_PUBLIC_APP_URL}/profile" class="button">Review Account Security</a>
      </div>
    </div>
    <div class="footer">
      <p>Need help? Contact our support team at <a href="mailto:${process.env.GMAIL_USER}">${process.env.GMAIL_USER}</a>
      </p>
      <p>© ${new Date().getFullYear()} RideShare. All rights reserved.</p>
  ...
  <div class="email-container">
    ...
    <div class="content">
      ...
      <div class="success-section">
        <div class="card-header text-success">✓ Password Successfully Updated</div>
        <p>Your RideShare account password was recently changed. This change was made on ${new Date().toLocaleString()}.
        </p>
      </div>

      <div class="warning-section">
        <div class="card-header text-destructive">⚠️ Didn't Change Your Password?</div>
        <p>If you did not authorize this change, please take immediate action:</p>
        ...
        <div class="list-item">
          <div class="list-icon">2</div>
          <div>Contact our support team at <a href="mailto:${process.env.GMAIL_USER}">${process.env.GMAIL_USER}</a>
          </div>
        </div>
        <div class="list-item">
          <div class="list-icon">3</div>
      ...
      <div class="info-section">
        <div class="card-header">Account Security Tips</div>
        <div class="list-item">
          <div class="list-icon">1</div>
